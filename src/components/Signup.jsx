  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 py-10 ">
      <form
        ...
        className="w-full max-w-xl bg-white shadow-2xl rounded-2xl border border-slate-200 p-8 flex flex-col gap-5"
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-2">
          ...
          <div className="w-full md:w-auto">
            ...
            <Input
              ...
              type="file"
              className="cursor-pointer file:bg-indigo-50 file:text-indigo-700 file:border-0 file:rounded-md file:px-2"
            />
          </div>
        </div>
