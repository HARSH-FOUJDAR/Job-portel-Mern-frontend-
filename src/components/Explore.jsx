        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            <header className="mb-8">
                ...
                {searchedQuery && (
                    <p className="text-slate-500 mt-2">
                        Showing results for <span className="font-semibold text-slate-700">"{searchedQuery}"</span>
                    </p>
                )}
            </header>
            ...
            {allJobs.length <= 0 ? (
                <div className="flex flex-col items-center justify-center min-h-[40vh] bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 p-10">
                    ...
                    <p className="text-slate-500">Try searching with different keywords or filters.</p>
                </div>
            ) : (
